...
public class TimeoutClientProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerTimeoutClientProcessor());
        testServerTh.start();
    ...
    private class TestServerTimeoutClientProcessor implements Runnable {
