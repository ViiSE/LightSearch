...
public class TimeoutServerProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerTimeoutServerProcessor());
        testServerTh.start();
    ...
    private class TestServerTimeoutServerProcessor implements Runnable {
