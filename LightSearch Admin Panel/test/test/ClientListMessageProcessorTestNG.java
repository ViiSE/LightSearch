...
public class ClientListMessageProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerClientListProcessor());
        testServerTh.start();
    ...
    private class TestServerClientListProcessor implements Runnable {

        private final Map<String, String> clients;
        
        public TestServerClientListProcessor() {
            clients = new HashMap<>();
