...
public class BotEntityProcessorAdvancedJSONTestNG {
    ...
    private final String botSettingsFileName = getResourcesFilesPath() + "bot_settings_advanced_test.json";
    ...
    public void apply() {
        ...
        BotEntityProcessor botProc = new BotEntityProcessorAdvancedJSON(
