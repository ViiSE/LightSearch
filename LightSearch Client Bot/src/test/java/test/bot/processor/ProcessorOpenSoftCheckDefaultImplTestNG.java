...
import lightsearch.client.bot.processor.ProcessorOpenSoftCheckDefaultImpl;
    ...
    private final class TestServer implements Runnable {
        ...
        public void run() {
            try(ServerSocket sock = new ServerSocket(50000)) {
                ...
                // Excepted Open SoftCheck Processor test.message with
                // IMEI 123456789012345, ident 001 and card_code 111
                String answer = "{"
                            + "\"IMEI\": \"123456789012345\","
                            + "\"is_done\": \"true\","
                            + "\"test.message\": \"SoftCheck is opened!\""
                        + "}";
