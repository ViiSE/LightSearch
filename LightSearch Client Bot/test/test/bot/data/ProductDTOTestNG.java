...
public class ProductDTOTestNG {
    ...
    public void id() {
        ...
        try {
            ...
            throw new RuntimeException("ID is not a number! Exception message: " + ex.getMessage());
        }
    ...
    public void amount() {
        ...
        try {
            ...
            throw new RuntimeException("Amount is not a number! Exception message: " + ex.getMessage());
        }
