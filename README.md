...
LightSearch - комплекс программ, предназначенный для предприятий, которые хотят внедрить мобильное, быстрое, не требующее много ресурсов решение поиска необходимых данных из базы данных.
