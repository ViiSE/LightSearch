...
@Scope("prototype")
public class CommandCheckerClientCancelSoftCheckImpl implements CommandChecker {
    ...
    public CommandCheckerClientCancelSoftCheckImpl(
    ...
    public void check() throws CheckerException {
        if(checker.isNull(command.IMEI(), command.userIdentifier(), command.cardCode()))
