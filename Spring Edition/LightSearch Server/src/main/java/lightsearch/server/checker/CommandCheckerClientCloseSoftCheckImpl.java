...
@Scope("prototype")
public class CommandCheckerClientCloseSoftCheckImpl implements CommandChecker {
    ...
    public CommandCheckerClientCloseSoftCheckImpl(
    ...
    public void check() throws CheckerException {
        if(checker.isNull(command.IMEI(), command.userIdentifier(), command.cardCode(), command.delivery()))
