...
@Scope("prototype")
public class CommandCheckerClientSearchImpl implements CommandChecker {
    ...
    public CommandCheckerClientSearchImpl(
    ...
    public void check() throws CheckerException {
        if(checker.isNull(command.IMEI(), command.barcode(), command.sklad(), command.TK()))
