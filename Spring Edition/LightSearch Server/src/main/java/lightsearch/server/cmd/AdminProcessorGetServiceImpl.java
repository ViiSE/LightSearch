...
@Service("adminProcessorGetServiceImpl")
@Scope("prototype")
public class AdminProcessorGetServiceImpl implements ProcessorService<AdminCommandResult> {
    ...
    public AdminProcessorGetServiceImpl(String command) {
    ...
    public Processor<? super Command, AdminCommandResult> getProcessor() throws ProcessorNotFoundException {
        ...
        ProcessorHolder holder = holderProducer.getProcessorHolderAdminGetInstance();
