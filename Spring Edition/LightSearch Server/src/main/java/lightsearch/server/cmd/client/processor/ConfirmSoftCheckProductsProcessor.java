...
@Component("confirmSoftCheckProductsProcessor")
@Scope("prototype")
public class ConfirmSoftCheckProductsProcessor implements ClientProcessor<ClientCommandResult> {
    ...
    public ConfirmSoftCheckProductsProcessor(
