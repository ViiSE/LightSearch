 ...
 * @author ViiSE
 */
@Component("closeSoftCheckProcessorClientDebug")
@Scope("prototype")
public class CloseSoftCheckProcessorDebug implements ProcessorClient {
    ...
    public CloseSoftCheckProcessorDebug(LightSearchServerDTO serverDTO, LightSearchChecker checker, SoftCheckDebug softCheck) {
