 ...
 * @author ViiSE
 */
@Component("confirmSoftCheckProductsProcessorClientDebug")
@Scope("prototype")
public class ConfirmSoftCheckProductsProcessorDebug implements ProcessorClient {
    ...
    public ConfirmSoftCheckProductsProcessorDebug(LightSearchServerDTO serverDTO, LightSearchChecker checker) {
