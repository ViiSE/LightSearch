...
@Component("cancelSoftCheckProcessorTest")
@Scope("prototype")
public class CancelSoftCheckProcessorTest implements ClientProcessor<ClientCommandResult> {
    ...
    public CancelSoftCheckProcessorTest(
