...
@Component("closeSoftCheckProcessorTest")
@Scope("prototype")
public class CloseSoftCheckProcessorTest implements ClientProcessor<ClientCommandResult> {
    ...
    public CloseSoftCheckProcessorTest(
