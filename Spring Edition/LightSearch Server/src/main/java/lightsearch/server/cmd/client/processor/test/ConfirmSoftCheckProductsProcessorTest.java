...
@Component("confirmSoftCheckProductsProcessorTest")
@Scope("prototype")
public class ConfirmSoftCheckProductsProcessorTest implements ClientProcessor<ClientCommandResult> {
    ...
    public ConfirmSoftCheckProductsProcessorTest(
