...
@Component("openSoftCheckProcessorTest")
@Scope("prototype")
public class OpenSoftCheckProcessorTest implements ClientProcessor<ClientCommandResult> {
    ...
    public OpenSoftCheckProcessorTest(
