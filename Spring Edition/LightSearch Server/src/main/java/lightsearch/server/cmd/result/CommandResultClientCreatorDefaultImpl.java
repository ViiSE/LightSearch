...
@Service("commandResultClientCreatorDefault")
@Scope("prototype")
public class CommandResultClientCreatorDefaultImpl implements CommandResultClientCreator {
    ...
    public CommandResultClientCreatorDefaultImpl(String name, LogMessageTypeEnum type, ResultTypeMessageEnum resultValue,
    ...
    public CommandResult createCommandResult() {
        ...
        if(resultValue.equals(ResultTypeMessageEnum.TRUE))
            messageType = msgTypeProducer.getMessageTypeClientJSONSuccessDefaultInstance();
        else
            messageType = msgTypeProducer.getMessageTypeClientJSONFailDefaultInstance();
