...
@Service("errorResultClientCommandCreatorDefault")
@Scope("prototype")
public class ErrorResultClientCommandCreatorDefaultImpl implements ErrorResultClientCommandCreator {

    private final ClientCommandResultCreatorProducer commandResultCreatorProducer;
    private final String IMEI;
    private final String message;

    public ErrorResultClientCommandCreatorDefaultImpl(
    ...
    @Override
    public ClientCommandResult createErrorResult() {
