...
import lightsearch.server.producer.cmd.system.SystemCommandProducer;
 ...
 * @author ViiSE
 */
@Component("systemCommandConverterDefault")
public class SystemCommandConverterDefaultImpl implements SystemCommandConverter {

    @Autowired SystemCommandProducer sysCmdProducer;
    ...
    public SystemCommand convertToSystemCommand(String message) throws CommandConverterException {
        if(message != null) {
            try {
                ...
                return sysCmdProducer.getSystemCommandDefaultJSONInstance(systemInfo);
            }
