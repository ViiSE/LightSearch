 ...
 * @author ViiSE
 */
@Component("databaseRecordIdentifierWriterDefault")
@Scope("prototype")
public class DatabaseRecordIdentifierWriterDefaultImpl implements DatabaseRecordIdentifierWriter {
    ...
    public DatabaseRecordIdentifierWriterDefaultImpl(LightSearchServerService serverService) {
        this.serverService = serverService;
    }
    
    @Override
    public void write(long databaseRecordIdentifier) throws IdentifierException {
        try(FileOutputStream fout = new FileOutputStream(serverService.currentDirectory() + "db_identifier")) {
