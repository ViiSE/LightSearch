...
public interface ClientCommandCreatorProducer {
    ClientCommandCreator getClientCommandCreatorDebugInstance(
            LightSearchServerDTO serverDTO, LightSearchListenerDTO listenerDTO, ClientDAO clientDAO);
    ClientCommandCreator getClientCommandCreatorDefaultInstance(
            LightSearchServerDTO serverDTO, LightSearchListenerDTO listenerDTO, ClientDAO clientDAO);
}
