...
public interface AdminCommandResultCreatorProducer {
    AdminCommandResultCreator getCommandResultCreatorAdminDefaultInstance(
            String isDone, String message, List<String> blacklist, List<Client> clients);
    AdminCommandResultCreator getCommandResultCreatorAdminErrorInstance(String message);
}
