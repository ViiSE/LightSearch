...
public interface DatabasePreparedStatementProducer {
    DatabasePreparedStatement getDatabasePreparedStatementSelectDefaultInstance(
            DatabaseConnection databaseConnection, String tableName, long lsCode, boolean state);
    DatabasePreparedStatement getDatabasePreparedStatementUpdateDefaultInstance(
            DatabaseConnection databaseConnection, String tableName, long lsCode, boolean state);
    DatabasePreparedStatement getDatabasePreparedStatementInsertWin1251DefaultInstance(
