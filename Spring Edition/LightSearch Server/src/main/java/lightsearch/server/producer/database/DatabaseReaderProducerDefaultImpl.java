...
@Service("databaseReaderProducerDefault")
public class DatabaseReaderProducerDefaultImpl implements DatabaseReaderProducer {
    ...
    @Override
    public DatabaseReader getDatabaseReaderDefaultInstance(DatabaseConnection databaseConnection, long lsCode) {
        return (DatabaseReader) ctx.getBean(DATABASE_READER, databaseConnection, lsCode);
    }
}
