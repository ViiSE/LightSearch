...
@Service("databaseWriterProducerDefault")
public class DatabaseWriterProducerDefaultImpl implements DatabaseWriterProducer {
    ...
    @Override
    public DatabaseWriter getDatabaseWriterDefaultInstance(DatabaseConnection databaseConnection, long lsCode, String dateTime, String command) {
        return (DatabaseWriter) ctx.getBean(DATABASE_WRITER, databaseConnection, lsCode, dateTime, command);
    }
}
