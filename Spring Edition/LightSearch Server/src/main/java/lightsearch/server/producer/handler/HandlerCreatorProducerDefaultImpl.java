...
@Service("handlerCreatorProducerDefault")
public class HandlerCreatorProducerDefaultImpl implements HandlerCreatorProducer {

    private final String HANDLER_CREATOR = "handlerCreatorDefault";
