...
public class MessageRecipientProducerDefaultImpl implements MessageRecipientProducer {
    ...
    private final String MESSAGE_RECIPIENT       = "messageRecipientDefault";
    ...
    @Override
    public MessageRecipient getMessageRecipientProducerDefaultInstance(DataInputStream dataInputStream) {
        return (MessageRecipient) ctx.getBean(MESSAGE_RECIPIENT, dataInputStream);
    }

    @Override
    public MessageRecipient getMessageRecipientProducerDebugInstance(DataInputStream dataInputStream) {
