...
public interface DatabaseRecordIdentifierWriterTimerCreatorProducer {
    DatabaseRecordIdentifierWriterTimerCreator getDatabaseRecordIdentifierWriterTimerCreatorDefaultInstance(
