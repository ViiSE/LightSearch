...
public interface DatabaseRecordIdentifierWriterTimerProducer {
    SuperDatabaseRecordIdentifierWriterTimer getDatabaseRecordIdentifierWriterTimerDefaultInstance(
