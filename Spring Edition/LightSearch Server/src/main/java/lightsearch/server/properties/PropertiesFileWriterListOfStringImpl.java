...
@Component("propertiesFileWriter")
@Scope("prototype")
public class PropertiesFileWriterImpl implements PropertiesWriter {

    private final String propertiesDirectory;
    private final Object data;
    private final boolean append;

    public PropertiesFileWriterImpl(String propertiesDirectory, Object data, boolean append) {
    ...
    public void write() throws WriterException {
        try (FileOutputStream fout = new FileOutputStream(propertiesDirectory, append);
            ...
            if(data instanceof List) {
                List<?> properties = new ArrayList<>((List<?>) data);
