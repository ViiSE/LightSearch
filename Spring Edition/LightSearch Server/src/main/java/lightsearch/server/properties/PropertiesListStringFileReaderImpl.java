...
@Component("propertiesListStringFileReader")
@Scope("prototype")
public class PropertiesListStringFileReaderImpl implements PropertiesReader<List<String>> {

    private final String propertiesDirectory;

    public PropertiesListStringFileReaderImpl(String propertiesDirectory) {
    ...
    public List<String> read() throws ReaderException {
        try {
            return Files.readAllLines(Paths.get(propertiesDirectory));
