...
INSERT INTO LS_RESPONSE(LSCODE, DDOC, CMDOUT, STATE)
    VALUES (1, FORMATDATETIME(CURRENT_TIMESTAMP, 'yyyy-MM-dd HH:mm:ss.s'), '{"IMEI":"111111111111111","is_done":"True","message":"Test auth!","ident":"777", "TK_list":["TK 1", "TK 2"],"sklad_list":["Sklad 1", "Sklad 2", "Sklad 3"]}', false);
