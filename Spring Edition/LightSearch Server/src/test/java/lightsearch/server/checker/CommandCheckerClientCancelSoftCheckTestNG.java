...
public class CommandCheckerClientCancelSoftCheckTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        ...
        checker = commandCheckerProducer.getCommandCheckerClientCancelSoftCheckInstance(
        ...
        testBegin("CommandCheckerClientCancelSoftCheck", "check()");
    }
    ...
    public void shutdownClass() {
        testEnd("CommandCheckerClientCancelSoftCheck", "check()");
    }
}
