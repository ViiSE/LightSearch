...
public class ProcessorAdminServiceTestNG extends AbstractTestNGSpringContextTests {

    @Autowired
    private ProcessorServiceProducer processorServiceProducer;

    private ProcessorService<AdminCommandResult> processorService;
    ...
    public void getProcessor() {
        testBegin("ProcessorAdminService", "getProcessor()");
        ...
        testEnd("ProcessorAdminService", "getProcessor()");
    }
}
