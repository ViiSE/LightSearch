...
public class ClientKickProcessorTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        ...
        admCmdDTO.setCommand(AdminCommandEnum.KICK.stringValue());
    ...
    private void printClients() {
        ...
        serverService.clientsService().clients().forEach((IMEI, client) -> System.out.println(IMEI));
    }
}
