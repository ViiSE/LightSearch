...
public class RestartTimeProcessorTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        ...
        admCmdDTO.setCommand(AdminCommandEnum.RESTART_TIME.stringValue());
        admCmdDTO.setRestartTime("17:00");
