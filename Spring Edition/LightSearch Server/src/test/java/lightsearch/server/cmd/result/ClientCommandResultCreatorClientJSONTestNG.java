...
public class ClientCommandResultCreatorClientJSONTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        String rawJSON = "{" +
                ...
                "\"is_done\":\"True\"," +
                "\"message\":\"SoftCheck is open!\"" +
                "}";

        cmdResCr = cmdResCrProducer.getCommandResultCreatorClientJSONInstance(rawJSON);
    }

    @Test
    public void createClientCommandResult() {
        testBegin("ClientCommandResultCreatorClientJSON" ,"createClientCommandResult()");
        ...
        testEnd("ClientCommandResultCreatorClientJSON" ,"createClientCommandResult()");
    }
}
