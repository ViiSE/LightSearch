...
public class DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSONTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        ...
        dbCmdMsg = dbCmdMsgProducer.getDatabaseCommandMessageCancelSoftCheckDefaultWindowsJSONInstance(
                cmdProducer.getClientCommandDefaultInstance(cmdDTO));
    }

    @Test
    public void message() {
        testBegin("DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSON", "message()");

        String message = dbCmdMsg.message();
        assertNotNull(message, "Message is null!");
        assertFalse(message.isEmpty(), "Message is empty!");
        System.out.println("Cancel SoftCheck message: " + message);

        testEnd("DatabaseCommandMessageCancelSoftCheckDefaultWindowsJSON", "message()");
    }
}
