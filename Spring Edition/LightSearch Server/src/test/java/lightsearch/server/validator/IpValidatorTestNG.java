...
public class IpValidatorTestNG extends AbstractTestNGSpringContextTests {
    ...
    public void setUpClass() {
        validator = validatorProducer.getIpValidatorInstance();
    ...
    @Test
    public void validate_fail_wrong_ip() {
        try {
            validator.validate("127.0.0.0.1");
        } catch(ValidatorException ex) {
            catchMessage(ex);
        }
    }
