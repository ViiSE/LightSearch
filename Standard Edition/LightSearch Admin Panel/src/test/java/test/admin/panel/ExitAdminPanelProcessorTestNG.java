...
public class ExitAdminPanelProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerExitAdminPanelProcessor());
        testServerTh.start();
    ...
    private class TestServerExitAdminPanelProcessor implements Runnable {
        ...
        public void run() {
            ...
            { 
                ...
                try {
                    ...
                    sendMsg += "\"name\": \"name\",\n";
                    sendMsg += "\"isDone\": \"True\",\n";
                    sendMsg += "\"message\": \"ExitAdminPanel\"\n";
                    sendMsg += "}";
