...
public class BlacklistRequestProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerBlacklistRequestProcessor());
        testServerTh.start();
    ...
    private class TestServerBlacklistRequestProcessor implements Runnable {

        private final List<String> blacklist;
        
        public TestServerBlacklistRequestProcessor() {
