...
import lightsearch.client.bot.processor.ProcessorCloseSoftCheckDefaultImpl;
    ...
    private final class TestServer implements Runnable {
        ...
        public void run() {
            try(ServerSocket sock = new ServerSocket(50000)) {
                ...
                // IMEI 123456789012345, ident 001, card_code 111, and delivery 1
                String answer = "{"
                            + "\"IMEI\": \"123456789012345\","
                            + "\"is_done\": \"true\","
                            + "\"test.message\": \"SoftCheck is closed!\""
                        + "}";
