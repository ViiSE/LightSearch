...
public class ChangeDatabaseProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerChangeDatabaseProcessor());
        testServerTh.start();
    ...
    private class TestServerChangeDatabaseProcessor implements Runnable {
        ...
        public void run() {
            ...
            { 
                ...
                try {
                    ...
                    sendMsg += "\"name\": \"name\",\n";
                    sendMsg += "\"isDone\": \"True\",\n";
                    sendMsg += "\"message\": \"ChangeDatabase\"\n";
                    sendMsg += "}";
