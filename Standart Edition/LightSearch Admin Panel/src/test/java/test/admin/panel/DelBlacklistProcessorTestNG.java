...
public class DelBlacklistProcessorTestNG {
    ...
    public void setUpMethod() {
        testServerTh = new Thread(new TestServerDelBlacklistProcessor());
        testServerTh.start();
    ...
    private class TestServerDelBlacklistProcessor implements Runnable {
