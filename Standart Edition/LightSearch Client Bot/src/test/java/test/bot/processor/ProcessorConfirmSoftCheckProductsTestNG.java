...
import lightsearch.client.bot.processor.ProcessorConfirmSoftCheckProductsDefaultImpl;
...
public class ProcessorConfirmSoftCheckProductsTestNG {
    ...
    private BotDAO getBotDAO() {
        ...
        _botDAO.setBotName("Super test.bot");
    ...
    private final class TestServer implements Runnable {
        ...
        public void run() {
            try(ServerSocket sock = new ServerSocket(50000)) {
                ...
                // Excepted Close SoftCheck Processor test.message with
                // IMEI 123456789012345, ident 001, card_code 111, and products:
                // 1) id:11111, amount:10
                // 2) id:22222, amount:20
                String answer = "{"
