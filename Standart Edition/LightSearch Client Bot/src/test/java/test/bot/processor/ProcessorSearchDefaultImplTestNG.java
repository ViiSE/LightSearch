...
public class ProcessorSearchDefaultImplTestNG {
    ...
    public void apply() {
        ...
        String sklad = "all";
        String TK = "all";
        assertNotNull(barcode, "Barcode is null!");
        assertNotNull(sklad, "Sklad is null!");
        assertNotNull(TK, "TK is null!");
        
        SearchDTO searchDTO = SearchDTOInit.searchDTO(barcode, sklad, TK);
    ...
    private final class TestServer implements Runnable {
        ...
        public void run() {
            try(ServerSocket sock = new ServerSocket(50000)) {
                ...
                // Excepted Search Processor test.message with
                // IMEI 123456789012345, barcode 11111, sklad all, and TK all
                String answer = "{"
