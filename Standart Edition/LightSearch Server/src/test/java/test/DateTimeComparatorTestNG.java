...
public class DateTimeComparatorTestNG {
    ...
    public void isAfter() {
        ...
        System.out.println("isAfter(" + currentDateTime.dateTimeInStandartFormat() + "," + LocalDateTime.now().toString() + ")");
        System.out.println("result: " + dateTimeComparator.isAfter(currentDateTime.dateTimeInStandartFormat(), LocalDateTime.now()));
        System.out.println("--------------------2--------------------");
        System.out.println();
    ...
    public void isBefore() {
        ...
        System.out.println("--------------------2--------------------");
        System.out.println("isBefore(" + currentDateTime.dateTimeInStandartFormat() + "," + LocalDateTime.now().toString() + ")");
        System.out.println("result: " + dateTimeComparator.isBefore(currentDateTime.dateTimeInStandartFormat(), LocalDateTime.now()));
        System.out.println("--------------------2--------------------");
        System.out.println();
