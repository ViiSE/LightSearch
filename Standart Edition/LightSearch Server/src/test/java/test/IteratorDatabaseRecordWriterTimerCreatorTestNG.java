 ...
 * @author ViiSE
 */
public class IteratorDatabaseRecordWriterTimerCreatorTestNG {
    ...
    public void getTimer() {
        testBegin("IteratorDatabaseRecordWriterTimerCreator", "getTimer()");
        ...
        IteratorDatabaseRecordWriterTimerCreator iteratorTimer = 
        ...
        System.out.println("IteratorDatabaseRecordWriterTimerCreator.getTimer(): " 
                + iteratorTimer.getTimer());
        
        testEnd("IteratorDatabaseRecordWriterTimerCreator", "getTimer()");
    }
}
